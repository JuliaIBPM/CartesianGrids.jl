...
struct GradDDF{C <: DDFType,OVERDX,D} <: AbstractDDF end
...
function (ddf::DDF{ddftype})(x::AbstractVector{::FD.Dual{T,V,M}},y::AbstractVector{::FD.Dual{T,V,M}}) where {T,V,M,ddftype<: DDFType}
